        ...
        methods: {
            deleteFolder(index){
                ...
                if(confirm("確定要刪除此分類資料夾?")){
                    ...
                    axios.post("http://localhost/yoyo/deleteFavFolder.php",qs.stringify({categoryId: categoryId}))
                        .then(res => {
                            // console.log(res);
                            this.favFolder = [];
                            this.selectFolder();
            ...
            addFolder(){
                ...
                if(newName === true){
                    axios.post("http://localhost/yoyo/addFavFolder.php",qs.stringify({categoryName: newName, memberId: this.memberId}))
                            .then(res => {
                                // console.log(res);
                                this.favFolder = [];
                                this.selectFolder();
            ...
            updateTitle(index){
                axios.post("http://localhost/yoyo/updateTitle.php",qs.stringify({categoryID: this.favFolder[index].categoryID, categoryName: this.favFolder[index].categoryName}))
                    .then(res => {
                        // console.log(res);
                    })
                    .catch(err => console.log(err));
