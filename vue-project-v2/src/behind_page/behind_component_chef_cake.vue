...
export default {
  ...
  methods: {
    ...
    sendData(){
      ...
      if (this.newFlavor.category == 1) {
        ...
        axios.post("./static/api/behindComponentChefCakeInsert.php", qs.stringify({
        name: this.newFlavor.name,
        description: this.newFlavor.description,
        img: this.newFlavor.img,
        price: this.newFlavor.price,
  ...
  mounted() {
    ...
    const params = new URLSearchParams();
        axios({
            method: "post",
            url: "./static/api/behindComponentChefCakeSelect.php",
            data: params,
        })
        .then((res) => {
          // console.log(res.data)
        ...
        .catch((error) => {
         ...
         axios({
            method: "post",
            url: "./static/api/behindComponentChefCakeSelectAll.php",
            data: params,
        })
        .then((res) => {
            // console.log(res.data);
