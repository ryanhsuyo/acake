        ...
        <!-- <div class="text_outline">
          <div class="infor">
            <div class="left_infor">
              ...
              <div class="second">
                <p>蛋糕名稱</p>
                <input type="text" v-model="newIdeaCake.newIdeaCake">
              </div>
              <div class="third">
                <p>吋數:</p>
              ...
              <div class="forth">
                <p>糕體口味：</p>
                <select name="" id="" v-model="newIdeaCake.newCakeFlavor">
            ...
            <div class="right_infor">
              ...
              <div class="second">
                <p>價格：</p>
                <input type="text" v-model="newIdeaCake.newCakePrice">
              </div>
              <div class="third">
                <p>10吋價格：</p>
                <p>等下</p>
          ...
          <div class="descript">
            ...
            <textarea
              ...
              cols="30"
              rows="7"
              v-model="newIdeaCake.description"
            ></textarea>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    sendData(){
      ...
      if(i == true){
        ...
        axios({
          data,
          url:"http://localhost/static/yoyo_api/behindComponentIdeaCakeInsert.php",
          method:"POST",
        }).then((res)=>{
    ...
    updateData(datas){
      ...
      if(i == true){
        ...
        axios({
          method:"POST",
          data,
          url:"http://localhost/static/yoyo_api/behindComponentIdeaCakeUpdate.php"
        }).then((res)=>{
          console.log(res.data)
        }).catch((err)=>{
          console.log(err)
  ...
  mounted() {
    ...
    //     axios({
    //         method: "post",
    //         url: "http://localhost/static/yoyo_api/behindComponentChefCakeSelectIngredient.php",
    //         data: INGREDIENT,
    //     })
    //     .then((res) => {
    //         let data = res.data;
