...
export default {
  ...
  methods: {
    ...
    updateCakeImageInput($event, index){
      ...
      reader.addEventListener("load", function(){
        ...
        axios.post("./static/jiawei.api/BE_updateCakeImage.php", qs.stringify({cakeID: cakeID, cakeImgBlob: reader.result}))
  ...
  mounted() {
    axios.post("./static/jiawei.api/BE_selectCake.php")
      .then(res => {
        let data = res["data"];
