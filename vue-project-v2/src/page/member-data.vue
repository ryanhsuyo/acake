    ...
    export default {
        ...
        methods: {
            ...
            updateData($event, check){
                ...
                axios.post("http://localhost/yoyo/updateMemberData.php", qs.stringify(inputValues))
            ...
            showDesignDetail(cake){
                ...
                this.designDetail = {};
                axios.post("http://localhost/yoyo/selectCakeIngredient.php",qs.stringify({cakeID: cake.cakeID}))
                    .then(res => {
                        console.log(res);
                        let data = res["data"];
                        this.designDetail = {
        ...
        mounted(){
            ...
            axios.post("http://localhost/yoyo/selectMemberData.php",qs.stringify({memberId: this.memberId}))
                    .then(res => {
                        // console.log(res);
                        let data = res.data[0];
            ...
            // 載入蛋糕設計資料
            axios.post("http://localhost/yoyo/selectCakeDesigns.php",qs.stringify({memberId: this.memberId}))
                    .then(res => {
                        // console.log(res);
                        let data = res["data"];
                        for(let i = 0; i < data.length; i++){
