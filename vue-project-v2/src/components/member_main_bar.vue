...
export default {
    ...
    methods: {
        ...
        uploadAvatar(){
            ...
            reader.addEventListener("load", function(){
                ...
                axios.post("http://localhost/yoyo/uploadAvatar.php",qs.stringify({memberId: memberId, imgBlob: reader.result}))
                    .then(res => {
                        // console.log(res);
                    })
    ...
    mounted(){
        ...
        axios.post("http://localhost/yoyo/selectAvatar.php",qs.stringify({memberId: this.memberId}))
            .then(res => {
                console.log(res);
